    ...
    def _initialize_recovery_graph(self):
        recovery_factors = [
            (
                "stress",
                NodeType.FACTOR,
                {"baseline": 0.5, "volatility": 0.3},
                {"category": "psychological"},
            ),
            (
                "social_support",
                NodeType.FACTOR,
                {"baseline": 0.7, "volatility": 0.2},
                {"category": "social"},
            ),
            (
                "coping_skills",
                NodeType.FACTOR,
                {"baseline": 0.6, "volatility": 0.4},
                {"category": "behavioral"},
            ),
            (
                "mood",
                NodeType.FACTOR,
                {"baseline": 0.5, "volatility": 0.5},
                {"category": "psychological"},
            ),
            (
                "sleep_quality",
                NodeType.FACTOR,
                {"baseline": 0.6, "volatility": 0.3},
            ...
            (
                "employment",
                NodeType.FACTOR,
                {"baseline": 0.5, "volatility": 0.1},
                {"category": "social"},
            ),
            (
                "financial_stress",
                NodeType.FACTOR,
                {"baseline": 0.4, "volatility": 0.3},
                {"category": "social"},
            ),
        ]
        ...
        interventions = [
            (
                ...
                {"effectiveness": 0.8, "accessibility": 0.6},
                {"type": "professional"},
            ),
            (
                "meditation",
                NodeType.INTERVENTION,
                {"effectiveness": 0.6, "accessibility": 0.9},
                {"type": "self_care"},
            ),
            (
                "exercise",
                NodeType.INTERVENTION,
                {"effectiveness": 0.7, "accessibility": 0.8},
                {"type": "lifestyle"},
            ),
            (
                "support_group",
                NodeType.INTERVENTION,
                {"effectiveness": 0.7, "accessibility": 0.7},
                {"type": "social"},
            ),
            (
                "medication",
                NodeType.INTERVENTION,
                {"effectiveness": 0.8, "accessibility": 0.5},
                {"type": "medical"},
            ),
        ]
        ...
        outcomes = [
            (
                "relapse_risk",
                NodeType.OUTCOME,
                {"severity": 0.8, "predictability": 0.7},
                {"primary": True},
            ),
            (
                "quality_of_life",
                NodeType.OUTCOME,
                {"importance": 0.9, "measurability": 0.6},
                {"primary": False},
            ),
            (
                "treatment_engagement",
                NodeType.OUTCOME,
                {"importance": 0.8, "measurability": 0.8},
                {"primary": False},
            ),
        ]
