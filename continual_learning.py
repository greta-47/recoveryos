...
class ContinualLearningStrategy(ABC):
    @abstractmethod
    def consolidate_knowledge(self, old_weights: Dict[str, np.ndarray], 
                            new_weights: Dict[str, np.ndarray],
                            importance: Dict[str, np.ndarray]) -> Dict[str, np.ndarray]:
        pass
...
class ClinicalContinualLearner:
    ...
    def learn_new_task(self, task_id: str, training_data: List[Dict[str, Any]], 
    ...
    def get_learning_insights(self) -> Dict[str, Any]:
        ...
        avg_performance = np.mean([l["performance"]["accuracy"] for l in recent_learning])
        avg_forgetting = np.mean([l["catastrophic_forgetting_score"] for l in recent_learning])
    ...
    def _generate_learning_insights(self, recent_learning: List[Dict[str, Any]]) -> List[str]:
        ...
        forgetting_scores = [l["catastrophic_forgetting_score"] for l in recent_learning]
