...
class EliteObservability:
    ...
    def track_request(self, endpoint_name: str, latency_ms: float, success: bool, request_data: Dict[str, Any] = None):
        ...
        logger.info(f"Elite endpoint request | Endpoint={endpoint_name} | Success={success} | Latency={latency_ms:.2f}ms | Data={safe_request_data}")
